/*************************************************  
 ...
 2012-11-20 By QW      添加双击放大,缩小动画.并添加m_isZoomingView以确保动画流畅.
...
@protocol QWScrollViewDataSource;

@protocol QWScrollViewDelegate;


@interface QWScrollView : UIView
	<UIScrollViewDelegate>
{
	 ...
	 **************************************************/
   __weak id<QWScrollViewDataSource> datasource;
	 ...
	 **************************************************/
   __weak id<QWScrollViewDelegate> delegate;
...
@property (nonatomic , weak) id<QWScrollViewDataSource> datasource;
@property (nonatomic , weak) id<QWScrollViewDelegate> delegate;
...
@protocol QWScrollViewDelegate <NSObject>

-(void)QWScrollViewDidChangedPage:(QWScrollView *)sender page:(int)page;

@end

@protocol QWScrollViewDataSource <NSObject>

-(UIView *)QWScrollViewDetailView:(QWScrollView *)sender index:(int)index superView:(UIView *)superView;
