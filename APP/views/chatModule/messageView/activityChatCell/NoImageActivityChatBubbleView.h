//
//  NoImageActivityChatBubbleView.h
//  APP
//
...
extern NSString *const kRouterEventNoImageActivityBubbleTapEventName;

@interface NoImageActivityChatBubbleView : BaseChatBubbleView
