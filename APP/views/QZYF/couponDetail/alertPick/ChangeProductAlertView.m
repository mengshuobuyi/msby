...
@interface ChangeProductAlertView()
{
...
@implementation ChangeProductAlertView
+(id)instance
{
    ...
    dispatch_once(&once, ^{
        NSArray* nibView =  [[NSBundle mainBundle] loadNibNamed:@"ChangeProductAlertView" owner:nil options:nil];
