...
//                
//                NSLog(@"the subscription list is %@",self.subscriptionList);
...
{
    //jxb
    //[APPDelegate showDiseaseBudge:NO];
}
...
//        [self.subscriptionList removeAllObjects];
//    }
//    self.subscriptionList = [APPDelegate.dataBase queryAllDiseaseSub];
//    if(self.subscriptionList.count > 0){
//        self.noneHintImage.hidden = YES;
//        self.noneHintLabel.hidden = YES;
//    }
...
//    if (APPDelegate.logStatus) {
//        
//        if (APPDelegate.currentNetWork == kNotReachable) {
//            [self loadDiseaseListFromLocal];
//        } else {
