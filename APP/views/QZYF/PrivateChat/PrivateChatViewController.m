...
//            [self scrollToBottomAnimated:NO];
    ...
    msgCenter.pullBack = ^(NSInteger obj){
        if (!weakSelf.sessionID.length) weakSelf.sessionID = weakMsg.sessionID;
        ...
        [QWGLOBALMANAGER noticeUnreadLocalWithType:MsgBoxListMsgTypeExpertPTP sessionID:weakSelf.sessionID isRead:YES];
    };
