...
- (void)setTagName:(NSString *)tagName
{
    ...
    CGSize size =[GLOBALMANAGER sizeText:tagName font:self.backImageButton.titleLabel.font constrainedToSize:CGSizeMake(300, 20)];
//    [tagName sizeWithFont:self.backImageButton.titleLabel.font constrainedToSize:CGSizeMake(300, 20)];
