...
- (void)viewDidLoad {
    ...
    self.tipsLabel.font = fontSystem(kFontS11);
    self.tipsLabel.textColor = RGBHex(qwColor8);
    self.phoneNumber.text = [NSString stringWithFormat:@"%@****%@",[self.phoneStr substringToIndex:3],[self.phoneStr substringFromIndex:7]];;
    ...
    self.tempLabel.textColor = RGBHex(qwColor8);
    self.phoneNumber.textColor = RGBHex(qwColor8);
