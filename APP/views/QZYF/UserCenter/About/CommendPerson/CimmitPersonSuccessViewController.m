...
- (void)viewDidLoad {
    ...
    self.title = @"提交成功";
    self.successLabel.textColor = RGBHex(qwColor1);
    [self.completeButton setTitleColor:RGBHex(qwColor1) forState:UIControlStateNormal];
    self.completeButton.layer.borderColor = RGBHex(qwColor1).CGColor;
