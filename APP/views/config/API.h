...
// 微商商品详情分享
#define SHARE_URL_WECHAT_PRODUCT(APPEND,APPEND2,APPEND3)      [NSString stringWithFormat:@"%@QWWAP/discount/html/goodsDetail.html?id=%@&branchId=%@&city=%@&refid=",H5_NEW_SHARE_URL,APPEND,APPEND2,APPEND3]
// 慢病订阅详情URL
