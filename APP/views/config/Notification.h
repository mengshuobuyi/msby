...
//3.0
    ...
    NotifCircleMsgRedPoint,         // 圈子和私聊小红点 //REMARK: 收到通知需要检查configure的flag设置对应小红点
    ...
    NotiMsgBoxNeedUpdateLocal,      //  消息盒子刷新缓存
    NotiMsgBoxNeedFetchNewData,     //  消息盒子拉取数据
    NotiDismissSwitchAnimationLoading,      //隐藏切换药房动画
    NotiReadNewLocation,            //在内容屏,读取新的地理位置
};
#endif
