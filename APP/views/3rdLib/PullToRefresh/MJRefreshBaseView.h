...
@property (nonatomic, strong)         UIImageView *refreshPatternImageView;
@property (nonatomic, weak, readonly) UIActivityIndicatorView *activityView;
@property (nonatomic, weak, readonly) UIImageView *imgvLoading;
@property (nonatomic, weak, readonly) UIImageView *imgBg;
#pragma mark - 回调
/**
 *  开始进入刷新状态的监听器
 */
 ...
 *
 *  @param setDiseaseCanLoadMore  add by meng
 */
@property (assign) BOOL diseaseCanLoadMore;
