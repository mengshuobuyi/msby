 ...
 *  @param date         发送时间
 */
- (void)didSendActivity:(NSString *)text content:(NSString *)content comment:(NSString *)comment activityUrl:(NSString *)activityUrl activityId:(NSString *)activityId fromSender:(NSString *)sender onDate:(NSDate *)date;
...
@property (nonatomic,strong)NSMutableArray *uploaderPhoto;
...
-(void)uploaderPhoto:(XHMessage *)addedMessage;
