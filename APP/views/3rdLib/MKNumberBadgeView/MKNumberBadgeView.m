...
{	
	...
	self.fillColor = RGBHex(qwColor3);
...
//    self.hidden = ![[((UINavigationController *)QWGLOBALMANAGER.tabBar.viewControllers[0]).viewControllers lastObject] isKindOfClass:[HomePageViewController class]] || (self.hideWhenZero && _value == 0);
