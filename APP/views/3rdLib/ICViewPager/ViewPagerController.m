...
- (IBAction)handleTapGesture:(id)sender {
    ...
    DDLogVerbose(@"%@",weakPageViewController.view);
...
//    DDLogVerbose(@"willTransitionToViewController: %i", [self indexForViewController:[pendingViewControllers objectAtIndex:0]]);
}
