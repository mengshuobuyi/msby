...
@protocol LeveyPopListViewCUSDelegate;
@interface LeveyPopListViewCUS : UIView <UITableViewDataSource, UITableViewDelegate>
{
...
@property (nonatomic, assign) id<LeveyPopListViewCUSDelegate> delegate;
...
@protocol LeveyPopListViewCUSDelegate <NSObject>
