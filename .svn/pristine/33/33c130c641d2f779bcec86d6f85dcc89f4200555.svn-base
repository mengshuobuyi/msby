...
#define LAYOUT_H_WITHOUTCENTER(VIEW1, OFFSET, VIEW2) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Create Row", CONSTRAINT_STACKING_H(VIEW1, VIEW2, OFFSET))
#define LAYOUT_V_WITHOUTCENTER(VIEW1, OFFSET, VIEW2) INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Create Column", CONSTRAINT_STACKING_V(VIEW1, VIEW2, OFFSET))
