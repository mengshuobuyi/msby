...
- (void)viewDidLoad {
    ...
    m_image = [UIImage imageNamed:@"功能介绍-2"];
    
    m_scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_W, SCREEN_H - 64)];
    UIImageView *m_imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_W, m_image.size.height/2)];
    m_imageView.backgroundColor = RGBHex(qwColor11);
    
    m_imageView.image = m_image;
    m_scrollView.contentSize = CGSizeMake(m_image.size.width/2, m_image.size.height/2);
//    m_scrollView.contentSize = CGSizeMake(m_image.size.width/2, m_image.size.height/2);
