...
typedef void (^pullMessageBlock) (NSInteger obj);

@interface PrivateMessageCenter : NSObject

@property (copy,nonatomic) pullMessageBlock pullBack;
...
- (BOOL)createMessage:(QWPrivateMessageModel*)msg;
- (BOOL)updateMessage:(MessageModel*)msg;
- (BOOL)updateMessage:(QWPrivateMessageModel*)msg where:(NSString*)where;
- (BOOL)deleteMessage:(QWPrivateMessageModel*)msg;
#pragma mark 数据转化
