 ...
 *  4.0.0 赠送大礼包
 */
@interface PresentGiftModel : BaseAPIModel
@property (nonatomic,assign) BOOL claimSuccess;          // 是否领取到礼包
@end
/**
 *  4.0.0 获取需要统计的商家
 */
@interface TdVo : BaseAPIModel
@property (nonatomic,strong) NSArray *groups; //用户名
@end

@interface TdGroupSimpleVo : BaseModel
@property (nonatomic,strong) NSString *groupId;     //昵称
@property (nonatomic,strong) NSString *groupName; //用户名
@end
