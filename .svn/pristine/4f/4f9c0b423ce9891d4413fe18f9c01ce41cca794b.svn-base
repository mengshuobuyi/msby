...
#define kXHStoreManagerItemWidth 90
...
- (void)setup {
    ...
    if (self.isShowEmotionStoreButton) {
        ...
        storeManagerItemButton.titleLabel.font = [UIFont systemFontOfSize:15.5];
        [storeManagerItemButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [storeManagerItemButton setBackgroundColor:RGBHex(qwColor13)];
