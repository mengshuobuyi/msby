...
//        ch = sch[i];
//        if ('A' <= ch && ch <= 'Z') {
//            sRes = [NSString stringWithFormat:@"%@%c",sRes,(char)ch];
//        } else if ('a' <= ch && ch <= 'z') {
//            sRes = [NSString stringWithFormat:@"%@%c",sRes,(char)ch];
//        } else if ('0' <= ch && ch <= '9') {
//            sRes = [NSString stringWithFormat:@"%@%c",sRes,(char)ch];
...
//            sRes = [NSString stringWithFormat:@"%@%c",sRes,(char)ch];
//        } else if (ch < 0x0F) {
//            sRes = [NSString stringWithFormat:@"%@%c",sRes,'%'];
//            sRes = [NSString stringWithFormat:@"%@%c",sRes,'0'];
//            sRes = [NSString stringWithFormat:@"%@%x",sRes,ch];
//        } else if (ch < 0xFF) {
//            sRes = [NSString stringWithFormat:@"%@%c",sRes,'%'];
//            sRes = [NSString stringWithFormat:@"%@%x",sRes,ch];
//        } else {
...
//                    hb = ch - '0';
//                }else{
//                    NSString* strCh = [NSString stringWithFormat:@"%c", (char)ch];
//                    NSString* lower = [strCh lowercaseString];
//                    char c = [lower characterAtIndex:0] - 'a';
//                    hb = 10 + c & 0xF;
//                }
//                
//                ch = sch[++i];
...
//                b = ch ;
//        }
//        sRes = [NSString stringWithFormat:@"%@%c",sRes,(char) b];
//    }
//    return sRes;
}
