...
@implementation GetCollectionPostListR
...
@implementation GetCircleMessageR

@end

@implementation UpDateMbrInfoR

@end

@implementation GetMyInfoR

@end

@implementation GetHealthCircleInfoR

@end

@implementation GetCircleSquareR
