...
//    [self naviRightBotton:@"取消" action:@selector(closeAction:)];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleDone target:self action:@selector(closeAction:)];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [self naviLeftBottonImage:image highlighted:imageHighlighted action:@selector(leftAction:)];
