...
#define kButtonWidth             35.0f
#define kButtonHeight            35.0f
#define kInputWidth              100.f
...
- (void)setupMessageInputViewBarWithStyle:(XHMessageInputViewStyle)style {
    ...
    if (self.allowsSendVoice) {
        button = [self createButtonWithImage:[UIImage imageNamed:@"icon_consulting_voice_rest"] HLImage:[UIImage imageNamed:@"icon_consulting_voice_selected"]];
    ...
    if (self.allowsSendMultiMedia) {
        button = [self createButtonWithImage:[UIImage imageNamed:@"icon_consulting_add_rest"] HLImage:[UIImage imageNamed:@"icon_consulting_add_selected"]];
        [button setImage:[UIImage imageNamed:@"keyborad"] forState:UIControlStateSelected];
    ...
    if (self.allowsSendFace) {
        button = [self createButtonWithImage:[UIImage imageNamed:@"icon_consulting_expression_rest"] HLImage:[UIImage imageNamed:@"icon_consulting_expression_selected"]];
        button.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin;
        [button setImage:[UIImage imageNamed:@"keyborad"] forState:UIControlStateSelected];
        [button addTarget:self action:@selector(messageStyleButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
        button.tag = 1;
    ...
    if (self.allowsSendVoice) {
        ...
        [button.titleLabel setFont:fontSystem(kFontS1)];
        [button setContentEdgeInsets:UIEdgeInsetsMake(1.5, 0, 0, 0)];
...
- (void)adjustTextViewHeightBy:(CGFloat)changeInHeight {
    ...
    DDLogVerbose(@"输入框textView的高度1 = %f",prevFrame.size.height);
    ...
    DDLogVerbose(@"输入框textView的高度2 = %f",self.inputTextView.frame.size.height);
