...
@interface HealthCellStyleThreeImg : QWBaseCell
...
@property (weak, nonatomic) IBOutlet UIImageView *imgViewTopicCenter;
@property (weak, nonatomic) IBOutlet UIImageView *imgViewTopicRight;
@property (weak, nonatomic) IBOutlet UIImageView *imgViewTopicLeft;
