...
- (BOOL) install
{
    ...
    if (!view)
    {
        DDLogVerbose(@"Error: Constraint cannot be installed. No common ancestor between items.");
        return NO;
    }
...
- (void) remove
{
    ...
    {
        DDLogVerbose(@"Error: Can only uninstall NSLayoutConstraint. %@ is an invalid class.", self.class.description);
        return;
    }
