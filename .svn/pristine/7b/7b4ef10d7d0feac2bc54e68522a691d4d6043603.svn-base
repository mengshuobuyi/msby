...
- (void)initializeUI {
    ...
    _hintImageView = [[UIImageView alloc] initWithFrame:CGRectMake((APP_W - 250) / 2, 80, 250, 170)];//250 170  /*120 120
    [_backGroundStausView addSubview:_hintImageView];

    _hintLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 250, APP_W, 21)];
    ...
    _hintButton.frame = CGRectMake((APP_W - 155 ) / 2.0, 290, 155, 40);
...
- (UIView *)createDynamicHeaderView:(NSInteger)section
{
    ...
    button.obj = model;
    if(model.choose) {
        [button setImage:[UIImage imageNamed:@"icon_shopping_selected1"] forState:UIControlStateNormal];
    }else{
        [button setImage:[UIImage imageNamed:@"icon_shopping_rest1"] forState:UIControlStateNormal];
    }
    ...
    UIView *rightSeparator = [[UIView alloc] initWithFrame:CGRectMake(APP_W - 20.5, 0, 0.5, 39)];
    rightSeparator.backgroundColor = RGBHex(qwColor10);
    [header addSubview:rightSeparator];
    
    UIView *leftSeparator = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 0.5, 39)];
    leftSeparator.backgroundColor = RGBHex(qwColor10);
    [header addSubview:leftSeparator];
    UIImageView *accessoryView = [[UIImageView alloc] initWithFrame:CGRectMake(APP_W - 40, (39 - 13 ) / 2.0 + 1, 8, 13)];
