...
- (void)setupHeaderView{
    ...
    headView.addressLabel.text = branchDetail.address;
...
- (void)shareAction:(id)sender{
    ...
    modelShare.shareLink = [NSString stringWithFormat:@"%@QWWAP/home/html/index.html?branchId=%@" ,H5_NEW_SHARE_URL,branchDetail.id];
...
- (void)checkCollect{
    ...
    if(QWGLOBALMANAGER.loginStatus) {
        ...
        [ConsultStore checkCollectBranch:self.branchId success:^(BaseAPIModel *model) {
...
- (void)collectBranch{
    ...
    [ConsultStore CollectBranch:self.branchId success:^(BaseAPIModel *model) {
...
- (void)cancelCollectBranch{
    ...
    [ConsultStore CancelCollectBranch:self.branchId success:^(BaseAPIModel *model) {
