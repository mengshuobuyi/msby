...
//        [_backButton setTitle:@"取消" forState:UIControlStateSelected];
        ...
        [_backButton setTitleColor:RGBHex(qwColor1) forState:UIControlStateSelected];
        ...
        [_actionButton setTitleColor:RGBHex(qwColor1) forState:UIControlStateSelected];
...
- (void)layoutSubviews
{
    ...
    DDLogVerbose(@"完成=======》%@",NSStringFromCGRect(selectRect));
