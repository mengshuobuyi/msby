...
{
    [QWGLOBALMANAGER statisticsEventId:@"我的_设置_消息提醒" withLable:@"我的_设置_消息提醒" withParams:nil];
...
{
    [QWGLOBALMANAGER statisticsEventId:@"我的_设置_修改密码" withLable:@"我的_设置_修改密码" withParams:nil];
    if (!QWGLOBALMANAGER.configure.setPwd) {
...
- (void) gotoFeedBack
{
    [QWGLOBALMANAGER statisticsEventId:@"我的_设置_意见反馈" withLable:@"我的_设置_意见反馈" withParams:nil];
...
- (void)clearMemoryWithIndexPath:(NSIndexPath *)indexPath{
    ...
    [QWGLOBALMANAGER statisticsEventId:@"我的_设置_清理缓存" withLable:@"我的_设置_清理缓存" withParams:nil];
...
{
    [QWGLOBALMANAGER statisticsEventId:@"我的_设置_关于问药" withLable:@"我的_设置_关于问药" withParams:nil];
...
- (void)bindWeixin
{
    [QWGLOBALMANAGER statisticsEventId:@"我的_设置_绑定微信号" withLable:@"我的_设置_绑定微信号" withParams:nil];
...
- (void)bindQQ
{
    [QWGLOBALMANAGER statisticsEventId:@"我的_设置_绑定QQ号" withLable:@"我的_设置_绑定QQ号" withParams:nil];
